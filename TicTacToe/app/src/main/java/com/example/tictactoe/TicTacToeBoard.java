...
public class TicTacToeBoard extends View {
    ...
    private void drawHorizontalLine(Canvas canvas, int row, int col) {
        canvas.drawLine(col, (float) (row * cellSize + cellSize / 2.0), cellSize * 3, (float) (row * cellSize + cellSize / 2), paint);
    }

    private void drawVerticalLine(Canvas canvas, int row, int col) {
        canvas.drawLine((float) (col * cellSize + cellSize / 2.0), row, (float) (col * cellSize + cellSize / 2.0), cellSize * 3, paint);
    }
